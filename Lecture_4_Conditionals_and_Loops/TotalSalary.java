...
public class TotalSalary {
    ...
    //Math.Round() is used to rounding of the result, whereas (int) is used for typecasting
    //the double value into integer and to print only the integral part of the final result i.e. 
    //totalSalary
